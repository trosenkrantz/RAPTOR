...
public record Transition(String input, String output, String nextState) {
    public byte[] outputAsBytes(int commandSubstitutionTimeout, List<String> captureGroups) {
        return BytesFormatter.intermediateEncodingToBytes(output, commandSubstitutionTimeout, captureGroups);
    }
}
